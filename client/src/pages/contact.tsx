      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Ready to find your next car or schedule a service?
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <Card className="mt-6">
              <CardHeader>
                <CardTitle className="text-lg">Visit Our Location</CardTitle>
              </CardHeader>
                ...
                <div className="p-4 bg-gray-50">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm font-medium">123 Auto Center Drive, Austin, TX 78701</span>
                    </div>
                    <a
        ...
        <Card className="mt-12">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Do you offer financing?</h3>
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Absolutely! We accept trade-ins and can provide competitive valuations for your current vehicle.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">What warranty do you offer?</h3>
                <p className="text-gray-600 text-sm">
                  All our used cars come with a comprehensive warranty. Extended warranty options are also available.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Can I schedule a test drive?</h3>
                <p className="text-gray-600 text-sm">
                  Yes! Contact us to schedule a test drive for any vehicle in our inventory.
                </p>
              </div>
            </div>
          </CardContent>
