...
export default function AdvancedCarFilters({ filters, onFiltersChange, onReset }: AdvancedCarFiltersProps) {
      ...
      <CardContent className="space-y-6">
        ...
        <Collapsible open={openSections.basic} onOpenChange={() => toggleSection('basic')}>
          ...
          <CollapsibleContent className="pt-4 space-y-4">
            <div>
              <Label>Make</Label>
              <Select value={filters.make || "any"} onValueChange={(value) => onFiltersChange({ make: value === "any" ? undefined : value })}>
                <SelectTrigger>
